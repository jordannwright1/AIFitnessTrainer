...
const GenerateProgramPage = () => {
    ...
    useEffect(() => {
      ...
      const handleMessage = (message: any) => {
        console.log('handleMessage triggered: ', message);
      ...
      if (callActive) vapi.stop()
        ...
        try {
          ...
          await vapi.start(process.env.NEXT_PUBLIC_VAPI_WORKFLOW_ID!, {variableValues: {
            full_name: firstName, //full_name changed to first name retroactively, so remains full_name here
            user_id: user?.id,
          }})
        } catch (error) {
        ...
        <div className='container mx-auto px-4 h-full max-w-5xl'>
          ...
          <div className='text-center mb-8'>
            ...
            <p className='text-muted-foreground mt-2'>
              Have a voice conversation with our AI Trainer to create your personalized plan
            </p>
          </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-6 mb-8'>
            ...
            <div className='aspect-video flex flex-col items-center justify-center p-6 relative'>
              ...
              <div className='relative w-full h-full rounded-full bg-card flex items-center justify-center border border-border overflow-hidden'>
                ...
                <img src="hero-ai.png" alt="AI Trainer" className='w-full h-full object-cover'/>
              </div>
              </div>
